...
exe             := pracs_exe
obj				:= obj
units_cc        := $(wildcard *.cpp) $(wildcard renderers/*.cpp) $(wildcard primitives/*.cpp) $(wildcard gl_abs/*.cpp) $(wildcard gl_abs/transformations/*.cpp) $(wildcard gl_abs/lights/*.cpp) $(wildcard mesh_abs/*.cpp) $(wildcard file_io/*.cpp) $(wildcard escena/*.cpp) $(wildcard animation_abs/*.cpp) $(wildcard hierarchical_models/neco_arc/*.cpp) $(wildcard hierarchical_models/mouse/*.cpp)
...
cc_flags_common := -std=c++17 -Wall -g -I/usr/include -I. -I./include -I./primitives -I./gl_abs -I./gl_abs/transformations -I./gl_abs/lights -I./mesh_abs -I./renderers -I./escena -I./animation_abs -I./hierarchical_models/neco_arc -I./hierarchical_models/mouse
