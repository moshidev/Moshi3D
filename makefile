...
exe             := pracs_exe
obj				:= obj
units_cc        := $(wildcard *.cpp) $(wildcard include/*.cpp) $(wildcard renderers/*.cpp) $(wildcard primitives/*.cpp) $(wildcard gl_abs/*.cpp) $(wildcard gl_abs/transformations/*.cpp) $(wildcard gl_abs/lights/*.cpp) $(wildcard mesh_abs/*.cpp) $(wildcard file_io/*.cpp) $(wildcard escena/*.cpp) $(wildcard escena/menus/*.cpp) $(wildcard animation_abs/*.cpp) $(wildcard hierarchical_models/*.cpp)
...
cc_flags_common := -std=c++17 -Wall -g -I/usr/include -I. -I./include -I./primitives -I./gl_abs -I./gl_abs/transformations -I./gl_abs/lights -I./mesh_abs -I./renderers -I./escena -I./escena/menus -I./animation_abs -I./file_io -I./hierarchical_models
